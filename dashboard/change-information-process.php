...
if (empty($registrantDateOfBirth) OR empty($registrantGender)) {	
	...
	$sql = "UPDATE trainees SET firstname = '$registrantFirstName', lastname = '$registrantLastName', date_of_birth = '$registrantDateOfBirth', gender = '$registrantGender' WHERE email = '$registrantEmail'";
