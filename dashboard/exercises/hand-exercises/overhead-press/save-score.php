...
margin: 40px 0px;">
	  ...
	  <a href="../index.php"><button>Go Back</button></a> 
		  ...
		  <script type="text/javascript"> 
			 ...
			 var userScore = localStorage.getItem("overheadPressRepeats");
			var userTime = Number(localStorage.getItem("overheadPressTime"));
					 var userWeight = localStorage.getItem("overheadPressWeight");
					  var userHand = localStorage.getItem("overheadPressHand");
