...
margin: 40px 0px;">
	  ...
	  <a href="../index.php"><button>Go Back</button></a> 
		  ...
		  <script type="text/javascript"> 
			 ...
			 var userScore = localStorage.getItem("bicepCurlsRepeats");
			var userTime = Number(localStorage.getItem("bicepCurlsTime"));
					 var userWeight = localStorage.getItem("bicepCurlsWeight");
					  var userHand = localStorage.getItem("bicepCurlsHand");
