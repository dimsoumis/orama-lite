...
$user = $_SESSION['userEmail'];  
 ...
 $sql1 = "select * from lateral_raises where user = '$user' ORDER BY reg_date DESC";  
        $result1 = mysqli_query($con, $sql1);  
        $count1 = mysqli_num_rows($result1);


$sqlStats = "select * from lateral_raises where user = '$user'";  
...
<main>
	...
	<h1 id="pageTitle">Lateral Raises</h1>
...
<p style="text-align: center;">Check the previous scores you have achieved.</p>
	...
	for ($x = 1; $x <= $noOfPages; $x++) {
		...
		$sqlLoop = "select * from lateral_raises where user = '$user' ORDER BY reg_date DESC LIMIT 20 OFFSET $x2";  
...
<a href="/dashboard/exercises/hand-exercises/index.php"><button>Upper-Limbs Exercises</button></a>
</p>
