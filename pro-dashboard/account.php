...
<script>
	...
	for (let i = 0; i < cancelInvitations.length; i++) {
		cancelInvitations[i].addEventListener("click", function() {
		 ...
		 $.ajax({
  method: "POST",
  url: "/pro-dashboard/cancel-invitation-process.php",
  data: { rowID: rowID },
  ...
  window.location.href='/pro-dashboard/account.php';
	...
	for (let i = 0; i < cancelConnections.length; i++) {
		cancelConnections[i].addEventListener("click", function() {
		 ...
		 $.ajax({
  method: "POST",
  url: "/pro-dashboard/cancel-connection-process.php",
  data: { rowID: rowID },
 success: function(data){ 	
	 if (data) {
  ...
  window.location.href='/pro-dashboard/account.php';
	...
	for (let i = 0; i < acceptInvitations.length; i++) {
		acceptInvitations[i].addEventListener("click", function() {
		 ...
		 $.ajax({
  method: "POST",
  url: "/pro-dashboard/accept-invitation-process.php",
  data: { rowID: rowID },
 success: function(data){ 	
	 if (data) {
  ...
  window.location.href='/pro-dashboard/account.php';
	...
	for (let i = 0; i < denyInvitations.length; i++) {
		denyInvitations[i].addEventListener("click", function() {
		 ...
		 $.ajax({
  method: "POST",
  url: "/pro-dashboard/deny-invitation-process.php",
  data: { rowID: rowID },
 success: function(data){ 	
	 if (data) {
